...
class GAT(object):
    def __init__(self, adj, adj_eval, features, labels, tvt_nids, cuda=-1, hidden_size=16, n_layers=1, epochs=200, seed=-1, lr=0.005, weight_decay=5e-4, dropout=0.6, print_progress=True, attn_drop=0.6, negative_slope=0.2, dropedge=0):
        self.t = time.time()
        self.lr = lr
