...
class JKNet():
    def __init__(self, adj, adj_eval, features, labels, tvt_nids, cuda=-1, hidden_size=128, n_layers=3, epochs=200, seed=-1, lr=1e-2, weight_decay=5e-4, dropout=0.5, print_progress=True, dropedge=0):
        self.t = time.time()
        self.lr = lr
        ...
        self.model = JKNet_model(self.features.size(1),
                                 hidden_size,
                                 self.n_class,
                                 n_layers,
                                 F.relu,
